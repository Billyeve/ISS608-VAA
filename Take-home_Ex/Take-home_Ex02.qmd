...
This code chunk is to import the data from AgeSex_SG2022_1.1.xlsx file to the Quarto/R page. Note that there are 3 sheets to take into consideration namely:

-   2022(Total) - shows the total population per category in 2022

-   2022(Male) - shows only the male population per category in 2022

-   2022(Female) - shows only the female population per category in 2022
...
::: callout-note
Ensure that the "2022" column is converted to numerical value instead of character
:::
